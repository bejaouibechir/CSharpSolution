...
-- --------------------------------------------------
-- Date Created: 04/06/2023 15:42:24
...
IF OBJECT_ID(N'[dbo].[FK_EmployeeProduit]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Produits] DROP CONSTRAINT [FK_EmployeeProduit];
GO
IF OBJECT_ID(N'[dbo].[FK_CategorieProduit]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Produits] DROP CONSTRAINT [FK_CategorieProduit];
GO
IF OBJECT_ID(N'[dbo].[FK_ClientProduit]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Produits] DROP CONSTRAINT [FK_ClientProduit];
GO
